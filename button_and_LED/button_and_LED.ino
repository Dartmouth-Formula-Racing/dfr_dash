...
// CAN message object receive in receive file
...
const int buttonPinDrive = 6; //17;     // testing for the button debouncing and using pin 6
const int buttonPinNeutral = 16;     
const int buttonPinReverse = 15;     

const int buttonDriveLED = 9;
const int buttonNeutralLED = 10;
const int buttonReverseLED = 11;
...
void setup() {
  ...
  pinMode(buttonDriveLED, OUTPUT);
  pinMode(buttonNeutralLED, OUTPUT);
  pinMode(buttonReverseLED, OUTPUT);
...
//  }
  ...
  if (buttonStateDrive == HIGH) { 
    ...
    digitalWrite(buttonDriveLED, HIGH);
    ...
    //buttonStateDrive == HIGH;
      ...
      digitalWrite(buttonDriveLED, LOW);
    }
  ...
  //If button the button is pressed, the state is LOW
    ...
    digitalWrite(buttonNeutralLED, HIGH);
    ...
    //buttonStateNeutral == HIGH;
      ...
      digitalWrite(buttonNeutralLED, LOW);
    }
 ...
 if (buttonStateReverse == LOW) { 
    ...
    Serial.println("reverse pressed");
    digitalWrite(buttonReverseLED, HIGH);
    
    } 
    else {
      digitalWrite(buttonReverseLED, LOW);
    }
